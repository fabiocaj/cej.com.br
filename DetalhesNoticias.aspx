<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DetalhesNoticias.aspx.vb" Inherits="DetalhesNoticias" %>
        ...
        <tr>
            <td valign="top" width="600px">
                ...
                <table  style="width:660px">
                    <tr>
                        <td>
                            <uc17:ucDetalhesNoticias ID="ucDetalhesNoticias1" runat="server" />
                        </td>
                    </tr>
                </table>
            ...
            <td valign="top" align="right">
                <uc5:ucultimas_noticias ID="ucultimas_noticias1" runat="server" />
            </td>
        </tr>
    </table>
    </tr>
