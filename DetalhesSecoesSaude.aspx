<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DetalhesSecoesSaude.aspx.vb" Inherits="DetalhesSecoesSaude" %>

<%@ Register Src="ucDicionario.ascx" TagName="ucDicionario" TagPrefix="uc15" %>
...
<td valign="top" width="850">
    <uc13:ucDetalhesSecoes ID="UcDetalhesSecoes1" runat="server" />
</td>
<td class="pontilhado">
<img src="layout/mundialline/images/pontilhado.gif" /></td>
<td valign="top">
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="10" valign="top">
            <uc15:ucDicionario ID="UcDicionario1" runat="server" />
        </td>
    </tr>
    <tr>
        <td height="10" valign="top">
