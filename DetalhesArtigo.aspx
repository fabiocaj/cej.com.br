<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DetalhesArtigo.aspx.vb" Inherits="DetalhesArtigo" %>
...
<%@ Register src="ucCategoriasArtigos.ascx" tagname="ucCategoriasArtigos" tagprefix="uc4" %>
<%@ Register src="ucDetalhesArtigo.ascx" tagname="ucDetalhesArtigo" tagprefix="uc5" %>
...
<td valign="top" width="850">
    <uc5:ucDetalhesArtigo ID="ucDetalhesArtigo1" runat="server" />
</td>
</tr>
</table>
</td>
