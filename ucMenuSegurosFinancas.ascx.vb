...
Partial Class ucMenuSegurosFinancas
    ...
    Sub sCarregarPanelRedeDescontos()
        ...
        'wSQL += " where SI.cSecao = " & wParametros.cSecaoSegurosFinancas 'Session("cSecao") 'wParametros.cSecaoSegurosFinancas
        'wSQL += " order by cSequencia "

        wSQL = "  Select * , t.tPagina as tPaginaTemplate"
        wSQL += " from tbSecaoItens SI"
        wSQL += " join tbTemplates T on si.cTemplate = t.cTemplate"
        wSQL += " where SI.cSecao = " & wParametros.cSecaoSegurosFinancas 'Session("cSecao") 'wParametros.cSecaoPadrao
        ...
        rpbSegurosFinancas.DataFieldID = "cMenu"
        rpbSegurosFinancas.DataFieldParentID = "cPai"
        rpbSegurosFinancas.DataSource = ds
        rpbSegurosFinancas.DataBind()

    End Sub

    Protected Sub rpbSegurosFinancas_OnPanelItemDataBound(ByVal sender As Object, ByVal e As RadPanelbarPanelItemDataBoundEventArgs)
